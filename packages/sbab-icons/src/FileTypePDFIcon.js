...
const FileTypePDFIcon = props => {
  const width = props.width || '48px';
  const height = props.height || '48px';

  return (
    <svg
      className="icon icon__filetype"
      width={width}
      height={height}
      viewBox="0 0 512 512"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="m451.7 99.72-71.4-71.44c-15.6-15.55-46.3-28.28-68.3-28.28h-240c-22 0-40 18-40 40v432c0 22 18 40 40 40h368c22 0 40-18 40-40v-304c0-22-12.7-52.7-28.3-68.28z" />
      <path
        fill="#fff"
